...
class BaseContabilidadSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        # Crear caja
        self.caja = Cajas.objects.create(nombre_caja="Caja Test", ubicacion="Test Location", estado=True)
...
class CajasSerializerTest(BaseContabilidadSerializerTest):
    ...
    def test_cajas_serializer_valid_data(self):
        ...
        valid_data = {"nombre_caja": "Nueva Caja Principal", "ubicacion": "Planta Baja - Sector A", "estado": True}
    ...
    def test_cajas_serializer_output_format(self):
        ...
        caja = Cajas.objects.create(nombre_caja="Caja Output Test", ubicacion="Test Location", estado=True)
...
class DocumentosTributariosSerializerTest(BaseContabilidadSerializerTest):
    ...
    def test_documentos_tributarios_serializer_output_format(self):
        ...
        expected_output = {
            ...
            "tipo_documento": "factura",
            "timbrado_info": {"nro_timbrado": 12345678, "punto_expedicion": "001-001"},
        }
...
class ImpuestosSerializerTest(BaseContabilidadSerializerTest):
    ...
    def test_impuestos_serializer_porcentaje_validation(self):
        ...
        porcentajes_validos = [Decimal("0.00"), Decimal("5.00"), Decimal("10.00")]  # Exento  # IVA 5%  # IVA 10%
    ...
    def test_impuestos_serializer_nombre_unique_validation(self):
        ...
        Impuestos.objects.create(
            nombre_impuesto="IVA Standard", porcentaje=Decimal("10.00"), vigente_desde=date.today()
        )
    ...
    def test_impuestos_serializer_vigencia_logic(self):
        ...
        impuesto_actual = Impuestos.objects.create(
            nombre_impuesto="IVA Actual", porcentaje=Decimal("10.00"), vigente_desde=date.today(), estado=True
        )
    ...
    def test_impuestos_serializer_output_with_calculations(self):
        ...
        impuesto = Impuestos.objects.create(
            nombre_impuesto="IVA Completo", porcentaje=Decimal("10.00"), vigente_desde=date.today(), estado=True
        )
        ...
        expected_output = {
            ...
            "porcentaje": "10.00",
            "estado": True,
            "ejemplo_calculo": {"monto_base": "50000.00", "monto_impuesto": str(impuesto_calculado)},
        }
...
class SerializersIntegrationTest(BaseContabilidadSerializerTest):
    ...
    def test_serializers_nested_data_handling(self):
        ...
        punto = PuntosExpedicion.objects.create(
            codigo_establecimiento="001", codigo_punto_expedicion="002", descripcion_ubicacion="Sucursal Norte"
        )
        ...
        nested_data = {
            "documento": {"nro_secuencial": documento.nro_secuencial, "monto_total": str(documento.monto_total)},
            "timbrado": {"nro_timbrado": timbrado.nro_timbrado, "tipo_documento": timbrado.tipo_documento},
            "punto_expedicion": {
    ...
    def test_serializers_performance_considerations(self):
        ...
        for i in range(10):
            caja = Cajas.objects.create(nombre_caja=f"Caja Performance {i}", ubicacion=f"Ubicación {i}", estado=True)
