...
class RolesSerializerTest(TestCase):
    ...
    def test_deserializacion_rol_valida(self):
        ...
        data = {"nombre_rol": "Cajero", "descripcion": "Rol de cajero", "estado": True}
    ...
    def test_validacion_nombre_rol_requerido(self):
        ...
        data = {"descripcion": "Rol sin nombre", "estado": True}
    ...
    def test_validacion_nombre_rol_unico(self):
        ...
        data = {"nombre_rol": "Existente", "descripcion": "Rol duplicado"}
    ...
    def test_descripcion_opcional(self):
        ...
        data = {"nombre_rol": "RolSinDescripcion", "estado": True}
    ...
    def test_actualizacion_rol(self):
        ...
        data = {"nombre_rol": "Actualizado", "descripcion": "Nueva descripción", "estado": False}
