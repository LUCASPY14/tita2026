...
class UsuariosMiddlewareTest(TestCase):
    ...
    def setUp(self):
        ...
        self.rol = Roles.objects.create(nombre_rol="MiddlewareTest", estado=True)
    ...
    def test_cors_headers_handling(self):
        ...
        def handle_cors(request, response):
            ...
            allowed_origins = ["http://localhost:3000", "https://cantina.example.com"]
    ...
    def test_timezone_middleware(self):
        ...
        def set_user_timezone(request):
            ...
            return {"timezone": user_tz, "activated": True}
        ...
        class ErrorHandlingMiddleware:
            ...
            def __call__(self, request):
                try:
                    ...
                    error_response = HttpResponse(f"Internal Error: {str(e)}", status=500)
                    return error_response

            def process_exception(self, request, exception):
                # Procesar excepción específica
                return HttpResponse("Error procesado por middleware", status=500)
    ...
    def test_request_timing_middleware(self):
        ...
        def measure_request_time(request, response):
            ...
            return {"start_time": start_time, "end_time": end_time, "processing_time": processing_time}
