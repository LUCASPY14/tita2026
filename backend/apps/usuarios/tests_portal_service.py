...
class TestPortalAuthServiceLogin:
    ...
    @patch("apps.usuarios.services.portal_service.PortalAuthService._generar_token")
    @patch("apps.usuarios.models.UsuariosPortal.objects.select_related")
    def test_login_actualiza_ultimo_acceso(self, mock_select_related, mock_generar_token, mock_portal_user):
    ...
    @patch("apps.usuarios.services.portal_service.PortalAuthService._generar_token")
    @patch("apps.usuarios.models.UsuariosPortal.objects.select_related")
    def test_login_normaliza_email_case_insensitive(self, mock_select_related, mock_generar_token, mock_portal_user):
    ...
    @patch("apps.usuarios.services.portal_service.PortalAuthService._generar_token")
    @patch("apps.usuarios.models.UsuariosPortal.objects.select_related")
    def test_login_elimina_espacios_del_email(self, mock_select_related, mock_generar_token, mock_portal_user):
...
class TestPortalAuthServiceIntegracion:
    ...
    @patch("apps.usuarios.services.portal_service.timezone.now")
    @patch("apps.usuarios.models.UsuariosPortal.objects.select_related")
    def test_flujo_completo_login_y_verificacion(self, mock_select_related, mock_now, mock_portal_user):
