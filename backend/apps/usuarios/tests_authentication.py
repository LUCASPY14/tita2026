...
class TestPortalJWTAuthentication:
    ...
    def test_autenticacion_exitosa_con_token_portal(
        self, mock_verificar_token, portal_jwt_auth, mock_portal_user
    ):
    ...
    @patch("apps.usuarios.authentication.PortalAuthService.verificar_token")
    def test_verificar_token_lanza_value_error(
        self, mock_verificar_token, portal_jwt_auth
    ):
    ...
    @patch("apps.usuarios.authentication.PortalAuthService.verificar_token")
    def test_verificar_token_token_invalido(
        self, mock_verificar_token, portal_jwt_auth
    ):
    ...
    @patch("apps.usuarios.authentication.PortalAuthService.verificar_token")
    def test_extrae_token_correctamente_de_header(
        self, mock_verificar_token, portal_jwt_auth, mock_portal_user
    ):
    ...
    @patch("apps.usuarios.authentication.PortalAuthService.verificar_token")
    def test_flujo_completo_autenticacion_portal(
        self, mock_verificar_token, portal_jwt_auth, mock_portal_user
    ):
        """Test de integración del flujo completo"""
        # Arrange
