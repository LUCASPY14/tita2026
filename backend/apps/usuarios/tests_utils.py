...
class UsuariosPermissionsTest(TestCase):
    ...
    def setUp(self):
        ...
        self.rol_cajero = Roles.objects.create(nombre_rol="Cajero", descripcion="Permisos limitados", estado=True)
...
class UsuariosSignalsTest(TestCase):
    ...
    def setUp(self):
        """Configurar datos de prueba"""
        self.rol = Roles.objects.create(nombre_rol="SignalTest", estado=True)
