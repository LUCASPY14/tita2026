...
class StockServiceTest(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.rol = Roles.objects.create(nombre_rol="Cajero", descripcion="Cajero de ventas")
    ...
    def test_validar_disponibilidad_stock_suficiente(self):
        ...
        validacion = StockService.validar_disponibilidad(
            producto_id=self.producto_con_stock.id_producto, cantidad_solicitada=Decimal("10.000")
        )
    ...
    def test_validar_disponibilidad_stock_insuficiente(self):
        ...
        validacion = StockService.validar_disponibilidad(
            producto_id=self.producto_sin_stock.id_producto, cantidad_solicitada=Decimal("5.000")
        )
    ...
    def test_validar_disponibilidad_multiple_productos(self):
        ...
        items = [
            ...
            {
                "id_producto": self.producto_permite_negativo.id_producto,
    ...
    def test_reservar_stock_exitoso(self):
        ...
        movimientos = MovimientosStock.objects.filter(
            id_producto=self.producto_con_stock, tipo_movimiento="Egreso", motivo="venta"
        )
...
class LotesProductoTest(TestCase):
    ...
    def setUp(self):
        ...
        # Crear categoría
        self.categoria = Categorias.objects.create(nombre="Lácteos")
...
class AlertasStockTest(TestCase):
    ...
    def setUp(self):
        ...
        self.stock = StockUnico.objects.create(
            id_producto=self.producto, cantidad=Decimal("10.000")  # Menor al stock_minimo (50)
        )
...
class AlertasVencimientoTest(TestCase):
    ...
    def setUp(self):
        ...
        # Crear unidad de medida
        self.unidad = UnidadesMedida.objects.create(nombre="Kilogramo", abreviatura="kg")

        # Crear categoría
        self.categoria = Categorias.objects.create(nombre="Carnes")
