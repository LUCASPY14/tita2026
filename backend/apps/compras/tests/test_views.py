...
class TestProveedoresViewSet:
    ...
    def test_list_proveedores_con_autenticacion(
        self,
    ...
    def test_cuenta_corriente_proveedor(
        self,
        authenticated_client,
        proveedor_test,
        empleado_test,
...
class TestComprasViewSet:
    ...
    def test_list_compras_con_autenticacion(
        self,
        authenticated_client,
        proveedor_test,
        medio_pago_efectivo
    ...
    def test_create_compra_sin_detalles(
        self,
        authenticated_client,
        proveedor_test,
        medio_pago_efectivo
    ...
    def test_calcular_totales_action(
        self,
        authenticated_client,
        producto_test
    ):
    ...
    def test_delete_compra_no_confirmada(
        self,
        authenticated_client,
        proveedor_test,
        medio_pago_efectivo
...
class TestComprasViewSetActions:
    ...
    def test_confirmar_compra_action(
        self,
        authenticated_client,
        proveedor_test,
        medio_pago_efectivo,
    ...
    def test_calcular_totales_action_con_detalles(
        self,
        authenticated_client,
        producto_test
    ):
    ...
    def test_calcular_totales_action_sin_detalles(
        self,
        authenticated_client
    ):
...
class TestComprasViewSetFilters:
    ...
    def test_filter_by_estado_pago(
        self,
        authenticated_client,
        proveedor_test,
        medio_pago_efectivo
    ...
    def test_search_by_nro_factura(
        self,
        authenticated_client,
        proveedor_test,
        medio_pago_efectivo
...
class TestProveedoresViewSetCuentaCorriente:
    ...
    def test_cuenta_corriente_incluye_info_proveedor(
        self,
        authenticated_client,
        proveedor_test
    ):
