...
def validar_tipo_reporte(value):
    ...
    """
    TIPOS_VALIDOS = ['Ventas', 'Inventario', 'Compras', 'Financiero', 'Cliente', 'Empleado', 'Personalizado']
...
def validar_categoria_kpi(value):
    ...
    """
    CATEGORIAS_VALIDAS = ['Ventas', 'Inventario', 'Compras', 'Financiero', 'Cliente', 'Empleado', 'Operacional']
...
def validar_tipo_tarea(value):
    ...
    """
    TIPOS_VALIDOS = ['Reporte', 'Backup', 'Limpieza', 'Sincronización', 'Cálculo', 'Notificación', 'Personalizado']
