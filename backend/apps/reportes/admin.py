...
class DashboardsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Información General', {
            'fields': ('nombre', 'descripcion', 'id_empleado', 'activo')
        }),
        ('Configuración', {
            'fields': ('configuracion', 'es_publico', 'predeterminado')
        }),
        ('Auditoría', {
...
class ValoresKpiAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Información General', {
            'fields': ('id_kpi', 'fecha', 'valor', 'auto_calc')
        }),
        ('Detalles', {
            'fields': ('notas', 'created_at'),
            'classes': ('collapse',)
        }),
    )
...
class PlantillasTareaAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Información General', {
            'fields': ('nombre', 'descripcion', 'tipo_tarea', 'activo')
        }),
        ('Configuración de Ejecución', {
            'fields': ('comando', 'parametros', 'frecuencia', 'cron', 'timeout', 'max_reintentos')
        }),
        ('Notificaciones', {
            'fields': ('notif_exito', 'notif_error')
        }),
        ('Auditoría', {
            'fields': ('created_by', 'created_at'),
            'classes': ('collapse',)
...
class EjecucionesTareaAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Información General', {
            'fields': ('id_plantilla', 'estado', 'servidor', 'pid')
        }),
        ('Tiempos de Ejecución', {
            'fields': ('fecha_inicio', 'fecha_fin', 'duracion_seg')
        }),
        ('Resultados', {
            'fields': ('resultado', 'error_msg', 'logs')
        }),
        ('Auditoría', {
            'fields': ('ejecutado_por', 'parametros'),
            'classes': ('collapse',)
        }),
    )
...
class DestinatariosTareaAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Información General', {
            'fields': ('id_plantilla', 'id_empleado')
        }),
        ('Preferencias de Notificación', {
            'fields': ('notif_inicio', 'notif_fin', 'notif_error')
        }),
    )
