...
class BaseReportesSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.rol = Roles.objects.create(nombre_rol="Analista Reportes", descripcion="Rol de analista", estado=True)
...
class PlantillasReporteSerializerTest(BaseReportesSerializerTest):
    ...
    def test_plantillas_reporte_serializer_valid_data(self):
        ...
        valid_data = {
            ...
            "parametros": {"mes": {"tipo": "integer", "requerido": True, "descripcion": "Mes a analizar (1-12)"}},
            "tipo_reporte": "ventas",
            "frecuencia": "mensual",
            "estado": True,
        }
        ...
        try:
            plantilla = PlantillasReporte.objects.create(
                **valid_data, created_at=timezone.now(), created_by=self.empleado
            )
    ...
    def test_plantillas_reporte_serializer_parametros_validation(self):
        ...
        # Parámetros válidos
        parametros_validos = {
            "fecha_inicio": {"tipo": "date", "requerido": True, "descripcion": "Fecha de inicio del período"},
            "fecha_fin": {"tipo": "date", "requerido": True, "descripcion": "Fecha de fin del período"},
            "empleado_id": {
                "tipo": "integer",
                "requerido": False,
        ...
        parametros_invalidos = {
            ...
            "parametro_tipo_invalido": {"tipo": "tipo_inexistente", "requerido": True},
        }
...
class DashboardsSerializerTest(BaseReportesSerializerTest):
    ...
    def test_dashboards_serializer_configuracion_validation(self):
        ...
        configuracion_valida = {
            "layout": {"tipo": "grid", "columnas": 12, "filas_auto": True},
            "tema": {"nombre": "claro", "colores_primarios": ["#007bff", "#28a745", "#dc3545"], "fuente": "Roboto"},
            "widgets": [
                {
                    "id": "widget_1",
                    "tipo": "chart",
                ...
                },
                {
                    ...
                    "configuracion": {"metrica": "ventas_diarias", "formato": "currency", "color_meta": "success"},
            ...
            "configuracion_avanzada": {"auto_refresh": True, "refresh_interval": 300, "cache_duration": 600},
        }
    ...
    def test_dashboards_serializer_widget_validation(self):
        ...
        widget_valido = {
            ...
            "configuracion": {"tipo_grafico": "bar", "datos_source": "ventas_por_producto"},
...
class PlantillasTareaSerializerTest(BaseReportesSerializerTest):
    ...
    def test_plantillas_tarea_serializer_cron_validation(self):
        ...
        for i, cron_expr in enumerate(cron_expressions_validas):
            config_programacion = {"tipo": "cron", "expresion": cron_expr, "zona_horaria": "America/Asuncion"}
...
class EjecucionesTareaSerializerTest(BaseReportesSerializerTest):
    ...
    def test_ejecuciones_tarea_serializer_status_validation(self):
        ...
        for estado in estados_validos:
            ejecucion = EjecucionesTarea.objects.create(
                id_plantilla_tarea=plantilla, estado=estado, fecha_inicio=timezone.now(), id_empleado=self.empleado
            )
    ...
    def test_ejecuciones_tarea_serializer_result_data(self):
        ...
        resultado_exitoso = {
            ...
            "estadisticas": {"total_ventas": 25000000, "promedio_venta": 16667, "max_venta": 500000},
        }
...
class ReportesSerializersIntegrationTest(BaseReportesSerializerTest):
    ...
    def test_serializers_chain_data_flow(self):
            ...
            "widgets": [
                {
                    ...
                    "configuracion": {"tipo_grafico": "line", "campo_x": "dia", "campo_y": "total"},
        ...
        tarea = PlantillasTarea.objects.create(
            ...
            configuracion_programacion={"tipo": "cron", "expresion": "0 9 * * 1-5"},  # Lunes a viernes a las 9 AM
        ...
        output_completo = {
            "dashboard": {"nombre": dashboard.nombre, "widgets": dashboard.configuracion["widgets"]},
            ...
            "tareas_programadas": [
                {"nombre": tarea.nombre, "expresion_cron": tarea.configuracion_programacion.get("expresion")}
            ],
        }
    ...
    def test_serializers_error_handling_consistency(self):
        ...
        for error in errores_comunes:
            ...
            error_response = {"field": error["campo"], "message": error["error"], "code": "validation_error"}
    ...
    def test_serializers_performance_considerations(self):
        ...
        for plantilla in plantillas:
            data = {
                "id_template": plantilla.id_template,
                "nombre": plantilla.nombre,
                "created_by": {"id_empleado": plantilla.created_by.id_empleado, "nombre": plantilla.created_by.nombre},
            }
