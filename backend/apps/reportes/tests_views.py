...
class BaseReportesViewsTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(username="test_reports", password="testpass123")
        ...
        self.categoria = CategoriaProductos.objects.create(
            nombre="Bebidas", descripcion="Categoría de bebidas", estado=True
        )
    ...
    def crear_datos_ventas_sample(self):
        ...
        for i in range(5):
            ...
            DetallesVenta.objects.create(
                id_venta=venta, id_producto=self.producto, cantidad=i + 1, precio_unitario=self.producto.precio_venta
            )
    ...
    def crear_datos_recargas_sample(self):
        ...
        # Crear tarjeta
        tarjeta = Tarjetas.objects.create(nro_tarjeta="1234567890", saldo=Decimal("100000.00"), estado=True)
...
class ReportesVentasViewTest(BaseReportesViewsTest):
    ...
    def test_reporte_ventas_formato_fecha_invalido(self):
        ...
        # Formato inválido
        params = {"fecha_inicio": "invalid-date", "fecha_fin": "2024-03-31"}
    ...
    def test_reporte_ventas_successful_response(self, mock_generar_reporte):
        ...
        url = reverse("reportes-reporte-ventas")
        params = {"fecha_inicio": "2024-03-01", "fecha_fin": "2024-03-31"}
...
class ReportesTopProductosViewTest(BaseReportesViewsTest):
    ...
    def test_reporte_top_productos_successful(self, mock_generar_reporte):
        ...
        params = {"fecha_inicio": "2024-03-01", "fecha_fin": "2024-03-31", "limite": "10"}
...
class ReportesConsumosTarjetaViewTest(BaseReportesViewsTest):
    ...
    def test_reporte_consumos_successful(self, mock_generar_reporte):
        ...
        url = reverse("reportes-reporte-consumos-tarjeta")
        params = {"nro_tarjeta": "1234567890", "fecha_inicio": "2024-03-01", "fecha_fin": "2024-03-31"}
...
class ReportesViewsIntegrationTest(BaseReportesViewsTest):
    ...
    def test_autenticacion_requerida_para_reportes(self):
        ...
        for url in endpoints_reportes:
            response = self.client.get(url, {"fecha_inicio": "2024-03-01", "fecha_fin": "2024-03-31"})
    ...
    def test_validacion_rangos_fecha_extremos(self):
        ...
        # Rango muy amplio
        params_amplio = {"fecha_inicio": "2020-01-01", "fecha_fin": "2024-12-31"}
        ...
        # Rango futuro
        params_futuro = {"fecha_inicio": "2025-01-01", "fecha_fin": "2025-12-31"}
    ...
    def test_performance_endpoints_reportes(self):
        ...
        endpoints_performance = [
            ...
            (reverse("reportes-reporte-ventas"), {"fecha_inicio": "2024-03-01", "fecha_fin": "2024-03-31"}),
        ]
    ...
    def test_formato_respuesta_consistente(self):
        ...
        with (
            patch("apps.reportes.services.ReporteService.generar_reporte_ventas") as mock_ventas,
            ...
            endpoints = [reverse("reportes-reporte-ventas"), reverse("reportes-kpis-principales")]
