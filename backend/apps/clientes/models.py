...
class Hijos(models.Model):
    ...
    activo = models.BooleanField(default=True, help_text="1=Activo, 0=Inactivo")
    id_cliente_responsable = models.ForeignKey('Clientes', models.DO_NOTHING, db_column='id_cliente_responsable', related_name='hijos')
...
class AutorizacionesSaldoNegativo(models.Model):
    ...
    monto_autorizado = models.DecimalField(max_digits=12, decimal_places=2, help_text="Monto máximo autorizado en negativo")
    ...
    id_venta = models.ForeignKey('ventas.Ventas', models.DO_NOTHING, db_column='id_venta', related_name='autorizaciones_saldo')
    id_cliente = models.ForeignKey('Clientes', models.DO_NOTHING, db_column='id_cliente', related_name='autorizaciones_saldo')
    id_empleado_autoriza = models.ForeignKey('usuarios.Empleados', models.DO_NOTHING, db_column='id_empleado_autoriza', related_name='autorizaciones_realizadas')
...
class LogsAutorizaciones(models.Model):
    ...
    id_tarjeta_autorizacion = models.ForeignKey('core.TarjetasAutorizacion', models.DO_NOTHING, db_column='id_tarjeta_autorizacion', related_name='logs')
