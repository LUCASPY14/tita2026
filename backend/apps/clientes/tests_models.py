...
class ClientesModelTest(TestCase):
    ...
    def test_credito_utilizado_sin_ventas(self):
        ...
        self.assertEqual(
            self.cliente.credito_utilizado,
            Decimal('0.00')
        )
    ...
    def test_credito_disponible_sin_ventas(self):
        ...
        self.assertEqual(
            self.cliente.credito_disponible,
            Decimal('1000000.00')
        )
    ...
    def test_porcentaje_credito_usado_cero(self):
        ...
        self.assertEqual(
            self.cliente.porcentaje_credito_usado,
            Decimal('0.00')
        )
...
class HijosModelTest(TestCase):
    ...
    def test_str_method(self):
        ...
        self.assertEqual(
            str(self.hijo),
            'Torres, Valentina (Séptimo Grado)'
        )
