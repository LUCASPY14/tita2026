...
class ClientesAdminBackupTest(TestCase):
    ...
    def setUp(self):
        ...
        self.admin_user = User.objects.create_user(
            "admin@test.com", password="testpass123", is_staff=True, is_superuser=True
        )
        ...
        self.hijo = Hijos.objects.create(
            nombre="Carlos", apellido="Pérez", id_cliente_responsable=self.cliente, grado=self.grado, estado=True
        )
    ...
    def test_all_models_registered(self):
        ...
        for model in expected_models:
            self.assertIn(model, admin.site._registry, f"Modelo {model.__name__} no está registrado")
