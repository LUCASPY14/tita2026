...
class ClientesURLRoutingTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user("testuser@test.com", password="testpass123")

        # Crear datos de prueba
        self.tipo_cliente = TiposCliente.objects.create(nombre_tipo="Cliente Test", estado=True)
...
class ClientesURLSecurityTest(TestCase):
    ...
    def test_path_disclosure_prevention(self):
        ...
        try:
            ...
            sensitive_paths = ["/etc/", "/home/", "/var/www/", "c:\\", "c:\\windows\\"]
...
class ClientesUrlsModuleImportTest(TestCase):
    ...
    def test_csrf_token_requirement(self):
        ...
        csrf_middleware = any("csrf" in middleware_class.lower() for middleware_class in middleware)
