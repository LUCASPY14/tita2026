...
class TestClientesPropertiesYMetodos:
    ...
    def lista_precios(self):
        ...
        return ListasPrecios.objects.create(nombre_lista="Lista Default", estado=True)

    @pytest.fixture
    def tipo_cliente(self):
        """Fixture: Tipo de cliente base"""
        return TiposCliente.objects.create(nombre_tipo="Cliente Regular", estado=True)
...
class TestHijosPropertiesYMetodos:
    ...
    def hijo(self):
        ...
        cliente = Clientes.objects.create(
            nombres="Roberto", apellidos="Martínez", ruc_ci="5555555", estado=True, id_lista=lista, id_tipo_cliente=tipo
        )
...
class TestGradosMetodos:
    ...
    def test_grado_str_method(self):
        ...
        grado = Grados.objects.create(
            nombre_grado="Primer Grado", nivel=1, orden_visualizacion=1, es_ultimo_grado=False, estado=True
        )
    ...
    def test_grado_str_method_ultimo_grado(self):
        ...
        # Arrange
        grado = Grados.objects.create(
            nombre_grado="Sexto Grado", nivel=6, orden_visualizacion=6, es_ultimo_grado=True, estado=True
        )
...
class TestHistorialGradosMetodos:
    ...
    def hijo_base(self):
        ...
        tipo = TiposCliente.objects.create(nombre_tipo="Padre", estado=True)
        cliente = Clientes.objects.create(
            nombres="Ana", apellidos="Torres", ruc_ci="7777777", estado=True, id_lista=lista, id_tipo_cliente=tipo
        )
        return Hijos.objects.create(
            nombre="Luis",
            apellido="Torres",
...
class TestRestriccionesHijosMetodos:
    ...
    def hijo_base(self):
        ...
        tipo = TiposCliente.objects.create(nombre_tipo="Padre", estado=True)
        cliente = Clientes.objects.create(
            nombres="Carlos", apellidos="Ramírez", ruc_ci="8888888", estado=True, id_lista=lista, id_tipo_cliente=tipo
        )
        return Hijos.objects.create(
            nombre="Sofia",
            apellido="Ramírez",
...
class TestLogsAutorizaciones:
    ...
    def tarjeta_autorizacion(self):
        ...
        tipo = TiposCliente.objects.create(nombre_tipo="Padre", estado=True)
        cliente = Clientes.objects.create(
            nombres="Diego", apellidos="Fernández", ruc_ci="9999999", estado=True, id_lista=lista, id_tipo_cliente=tipo
        )
        ...
        return TarjetasAutorizacion.objects.create(
            codigo_barra="AUTH-2026-001", tipo_autorizacion="temporal", estado=True, fecha_creacion=datetime.now()
        )
