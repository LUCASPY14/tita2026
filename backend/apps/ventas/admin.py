...
class NotasCreditoClienteAdmin(admin.ModelAdmin):
    list_display = ['id_nota', 'nro_nota_credito', 'id_cliente', 'fecha_emision', 'monto_total', 'estado']
    list_filter = ['estado', 'fecha_emision']
    ordering = ['-fecha_emision']

@admin.register(Promociones)
class PromocionesAdmin(admin.ModelAdmin):
    list_display = ['id_promocion', 'nombre', 'tipo_promocion', 'fecha_inicio', 'fecha_fin', 'activo']
