...
class Ventas(models.Model):
    ...
    monto_gravada_10 = models.DecimalField(
        max_digits=12, decimal_places=2, default=Decimal("0.00"), help_text="Base imponible gravada al 10%"
    )
    monto_gravada_5 = models.DecimalField(
        max_digits=12, decimal_places=2, default=Decimal("0.00"), help_text="Base imponible gravada al 5%"
    )
    monto_exenta = models.DecimalField(
        max_digits=12, decimal_places=2, default=Decimal("0.00"), help_text="Monto exento de IVA"
    )
    ...
    iva_5 = models.DecimalField(
        max_digits=12, decimal_places=2, default=Decimal("0.00"), help_text="IVA liquidado al 5% (monto_gravada_5 / 21)"
    )
...
class DetallesVenta(models.Model):
    ...
    iva_10 = models.DecimalField(
        max_digits=12, decimal_places=2, default=Decimal("0.00"), help_text="IVA liquidado al 10% (subtotal / 11)"
    )
    iva_5 = models.DecimalField(
        max_digits=12, decimal_places=2, default=Decimal("0.00"), help_text="IVA liquidado al 5% (subtotal / 21)"
    )
...
class PagosVenta(models.Model):
    ...
    ref_pago_pos = models.CharField(
        max_length=100, blank=True, null=True, help_text="Número de referencia generado por el terminal POS"
    )
    ref_pg_transf = models.CharField(
        max_length=100, blank=True, null=True, help_text="Número de referencia/comprobante de transferencia bancaria"
    )
    banco_emisor = models.CharField(
        max_length=100, blank=True, null=True, help_text="Banco emisor del pago (transferencia o tarjeta)"
    )
