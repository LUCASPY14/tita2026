...
from apps.compras.models import Proveedores, Compras, AplicacionPagosCompras, PagosProveedores, NotasCreditoProveedor
...
class CuentaCorrienteClienteTest(TestCase):
    ...
    def test_actualizacion_saldo_con_pago(self):
        ...
        AplicacionPagosVentas.objects.create(
            monto_aplicado=Decimal('80000.00'),
            id_pago_venta=pago,
            id_venta=venta
        )
...
class CuentaCorrienteProveedorTest(TestCase):
    ...
    def test_actualizacion_saldo_compra_con_pago(self):
        ...
        AplicacionPagosCompras.objects.create(
            monto_aplicado=Decimal('150000.00'),
            id_compra=compra,
