...
class PagosClientesAdmin(admin.ModelAdmin):
    ...
    search_fields = ["id_cliente__nombres", "id_cliente__apellidos", "id_cliente__ruc_ci", "referencia"]
...
class AplicacionPagosClientesAdmin(admin.ModelAdmin):
    list_display = ["id_aplicacion", "id_pago_cliente", "id_venta", "monto_aplicado", "fecha_aplicacion"]
