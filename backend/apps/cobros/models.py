...
class PagosClientes(models.Model):
    ...
    referencia = models.CharField(
        ...
        blank=True,
        null=True,
        help_text='Número de referencia/comprobante'
    )
    banco_emisor = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        help_text='Banco emisor (transferencia/cheque)'
    )
    ...
    estado = models.CharField(
        max_length=20,
        default='Confirmado',
        help_text='Estado del pago: Confirmado, Anulado'
    )
    id_cierre = models.BigIntegerField(
        blank=True,
        null=True,
        help_text='ID del cierre de caja asociado'
    )
    ...
    def monto_aplicado(self):
        ...
        total = self.aplicaciones.aggregate(
...
class AplicacionPagosClientes(models.Model):
    ...
    monto_aplicado = models.DecimalField(
        max_digits=12,
        decimal_places=2,
        help_text='Monto aplicado a esta factura'
    )
