...
class TestIsCajeroOrAdminPermission:
    ...
    def user_regular(self):
        ...
        return User.objects.create_user(
            username="user_regular", password="testpass123", is_staff=False, is_superuser=False
        )
    ...
    def user_staff(self):
        ...
        return User.objects.create_user(
            username="admin_user", password="adminpass123", is_staff=True, is_superuser=False
        )

    @pytest.fixture
    def rol_cajero(self):
        """Fixture: Rol de cajero"""
        return Roles.objects.create(nombre_rol="Cajero", descripcion="Rol de cajero del sistema", estado=True)

    @pytest.fixture
    def rol_administrador(self):
        """Fixture: Rol de administrador"""
        return Roles.objects.create(nombre_rol="Administrador", descripcion="Rol administrativo", estado=True)
