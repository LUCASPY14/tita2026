...
class CategoriasAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['nombre_con_jerarquia', 'id_categoria', 'categoria_padre_link', 'total_productos', 'estado_badge', 'nivel_jerarquia']
    ...
    def desactivar_categorias(self, request, queryset):
        ...
        if count > 0:
            ...
            self.message_user(request, 'No se desactivaron categorías (tienen productos activos).', level='warning')
...
class ProductosAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['codigo_barra_badge', 'descripcion_corta', 'categoria_tag', 'impuesto_info', 
                    'stock_minimo_display', 'permite_stock_neg', 'estado_badge']
    ...
    fieldsets = (
        ('Información Básica', {
            'fields': ('codigo_barra', 'descripcion', 'activo')
        }),
        ('Clasificación', {
...
class ListasPreciosAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['nombre_lista_badge', 'moneda_display', 'fecha_vigencia_display', 
                    'total_precios', 'estado_badge']
    ...
    fieldsets = (
        ('Información Básica', {
            'fields': ('nombre_lista', 'moneda', 'activo')
        }),
        ('Vigencia', {
...
class PreciosPorListaAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['producto_info', 'lista_badge', 'precio_display', 'fecha_vigencia_display', 'precio_anterior_info']
    list_filter = ['id_lista', 'fecha_vigencia']
    search_fields = ['id_producto__descripcion', 'id_producto__codigo_barra', 'id_lista__nombre_lista']
    ...
    fieldsets = (
        ('Producto y Lista', {
            'fields': ('id_producto', 'id_lista')
        }),
        ('Precio', {
            'fields': ('precio_unitario',),
            'description': 'Precio del producto en esta lista'
        }),
    )
    ...
    def precio_anterior_info(self, obj):
        ...
        precio_anterior = PreciosPorLista.objects.filter(
...
class HistoricoPreciosAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['producto_link', 'precio_anterior_display', 'flecha', 'precio_nuevo_display', 
                    'variacion_display', 'fecha_cambio_display', 'empleado_info']
    list_filter = ['fecha_cambio']
    search_fields = ['id_producto__descripcion', 'id_producto__codigo_barra', 'id_empleado__nombre', 'id_empleado__apellido']
    ...
    def producto_link(self, obj):
        ...
        return format_html(
            ...
            url, obj.id_producto.descripcion[:40]
        )
    ...
    def variacion_display(self, obj):
        ...
        return format_html(
            ...
            color, simbolo, abs(obj.variacion_porcentual)
        )
    ...
    def empleado_info(self, obj):
        ...
        if obj.id_empleado:
            return format_html(
                ...
                obj.id_empleado.nombre, obj.id_empleado.apellido
            )
