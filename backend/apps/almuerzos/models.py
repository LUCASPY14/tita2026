...
class RegistrosConsumoAlmuerzo(models.Model):
    ...
    id_hijo = models.ForeignKey('clientes.Hijos', models.DO_NOTHING, db_column='id_hijo')
    id_suscripcion = models.ForeignKey('SuscripcionesAlmuerzo', models.DO_NOTHING, db_column='id_suscripcion', blank=True, null=True)
    id_tipo_almuerzo = models.ForeignKey('TiposAlmuerzo', models.DO_NOTHING, db_column='id_tipo_almuerzo', blank=True, null=True)
