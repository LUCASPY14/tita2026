...
class IndependenciaAlmuerzoCantinaTest(TestCase):
    ...
    def test_registro_almuerzo_sin_suscripcion_no_descuenta_saldo_cantina(self):
        ...
        hijo_sin_suscripcion = Hijos.objects.create(
            nombre='Carlos', apellido='Martínez', grado='2do',
            activo=True, id_cliente_responsable=self.cliente
        )
...
class SuscripcionesAlmuerzoTest(TestCase):
    ...
    def setUp(self):
        ...
        cliente = Clientes.objects.create(
            nombres='Laura', apellidos='Fernández', ruc_ci='77777777',
            limite_credito=Decimal('500.00'), activo=True,
            id_lista=lista, id_tipo_cliente=tipo_cliente
        )
        
        self.hijo = Hijos.objects.create(
            nombre='Diego', apellido='Fernández', grado='3ro',
...
class CuentasAlmuerzoMensualTest(TestCase):
    ...
    def setUp(self):
        ...
        cliente = Clientes.objects.create(
            nombres='Patricia', apellidos='Sosa', ruc_ci='88888888',
            limite_credito=Decimal('500.00'), activo=True,
            id_lista=lista, id_tipo_cliente=tipo_cliente
        )
        
        self.hijo = Hijos.objects.create(
            nombre='Martín', apellido='Sosa', grado='5to',
            activo=True, id_cliente_responsable=cliente
        )
    ...
    def test_cuenta_unica_por_hijo_por_mes(self):
        ...
        cuentas = CuentasAlmuerzoMensual.objects.filter(
            id_hijo=self.hijo,
            anio=2026,
            mes=3
        )
