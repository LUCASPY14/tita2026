...
class ApiIntegrationsConfigTest(TestCase):
    ...
    def setUp(self):
        ...
        self.app_config = ApiIntegrationsConfig("apps.api_integrations", "apps.api_integrations")
    ...
    def test_app_config_verbose_name(self):
        ...
        expected_verbose_names = ["API Integrations", "Api Integrations", "Integraciones API", "API_Integrations"]
    ...
    def test_app_config_migration_modules(self):
        ...
        api_integrations_migrations = [key for key in app_migrations.keys() if key[0] == "api_integrations"]
    ...
    def test_app_config_services_importable(self):
        ...
        try:
            ...
            self.assertTrue(hasattr(services, "__file__") or hasattr(services, "__path__"))
        except ImportError:
...
class ApiIntegrationsAppIntegrationTest(TestCase):
    ...
    def test_app_settings_configuration(self):
        ...
        bancard_configs = ["BANCARD_AMBIENTE", "BANCARD_PUBLIC_KEY", "BANCARD_PRIVATE_KEY"]
