...
class ProveedoresApiAdminTest(TestCase):
    ...
    def setUp(self):
        ...
        # Crear usuario admin
        self.user = User.objects.create_superuser(username="admin", email="admin@test.com", password="admin123")
    ...
    def test_admin_list_display(self):
        ...
        expected_fields = ["id_proveedor", "nombre", "tipo_servicio", "url_base", "version", "estado", "created_at"]
...
class EndpointsApiAdminTest(TestCase):
    ...
    def test_admin_list_display(self):
        ...
        expected_fields = ["id_endpoint", "nombre", "proveedor_nombre", "metodo", "path", "requiere_auth", "estado"]
...
class LogsLlamadasApiAdminTest(TestCase):
    ...
    def setUp(self):
        ...
        # Crear empleado
        self.rol = Roles.objects.create(nombre_rol="AdminRole", descripcion="Rol para admin tests", estado=True)
    ...
    def test_admin_list_display_logs(self):
        ...
        expected_fields = ["id_log", "timestamp", "metodo", "url", "status_code", "tiempo_ms", "exitoso", "intento"]
...
class LogsWebhooksAdminTest(TestCase):
    ...
    def test_admin_list_filter_webhook_logs(self):
        ...
        expected_filters = ["evento_tipo", "verificacion_ok", "procesado_ok", "timestamp"]
...
class WebhookEndpointsAdminTest(TestCase):
    ...
    def test_admin_list_display_webhook_endpoints(self):
        ...
        expected_fields = ["id_webhook", "nombre", "proveedor_nombre", "path", "requiere_verificacion", "estado"]
    ...
    def test_admin_list_filter_webhook_endpoints(self):
        ...
        expected_filters = ["requiere_verificacion", "estado", "id_proveedor", "created_at"]
...
class ApiIntegrationsAdminIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_superuser(
            username="integration_admin", email="integration@test.com", password="integration123"
        )
