...
<p>Recomendamos realizar una recarga.</p>""",
        ...
        "variables": ["nombre_destinatario", "nombre_hijo", "nro_tarjeta", "saldo_actual", "saldo_alerta"],
        "categoria": "alertas",
    },
    {
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if options["reset"]:
            deleted = PlantillasEmail.objects.filter(codigo__in=[t["codigo"] for t in TEMPLATES]).delete()
